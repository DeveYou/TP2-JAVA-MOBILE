...
import com.example.pizza.services.ProduitService;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        liste.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(ListPizzaActivity.this, DetailsProduitActivity.class);
                ...
                intent.putExtra("preparation", selectedProduct.getPreparation());
                intent.putExtra("photo", String.valueOf(selectedProduct.getPhoto()));

                //debug
                Log.d(TAG, "product image id : " + selectedProduct.getPhoto());
